  ...
  <div class="main-header">
    ...
    <el-table
      ...
      <el-table-column fixed="right" label="操作" width="300px" align="center">
        <template v-slot="scope">
          <el-button type="primary" @click="(showPreview=true)&&(imageUrl=scope.row.url)">预览</el-button>
    ...
    <div style="margin: 10px 0">
      ...
      />
      <el-dialog append-to-body v-model="showPreview">
        <!-- 使用 flex 布局居中 -->
        <div style="display: flex; justify-content: center; align-items: center; height: 100%;">
          <img :src="imageUrl" style="max-height: 80%; max-width: 80%;" alt="预览图片"/>
        </div>
      </el-dialog>
    </div>
  </div>
