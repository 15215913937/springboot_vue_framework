                    ...
                    <div style="margin: 10px;height: 120px;display: flex;flex-direction: column;width:100%">
                        <div style="flex:1;display: flex;margin: 20px 0">
                            <div style="flex: 1;text-align: left;font-size: 20px">本月支出:&nbsp-&nbsp<span
                                    style="color:green">{{
                  currentMonthExpense
                              }}</span>&nbsp元&nbsp<span style="font-size: 10px">↓20%</span>
                            </div>
                            <div style="flex: 1;text-align: left;font-size: 20px">本月收入:&nbsp+&nbsp<span
                                    style="color: red">{{
                  currentMonthIncome
                              }}</span>&nbsp元<span style="font-size: 10px">↑18.98%</span>
                            </div>
                        </div>
                        <div style="flex:1;display: flex;margin: 20px 0">
                            <div style="flex: 1;text-align: left;font-size: 17px">上月支出:&nbsp&nbsp&nbsp-&nbsp{{
                                lastMonthExpense }}&nbsp元
                            </div>
                            <div style="flex: 1;text-align: left;font-size: 17px">上月收入:&nbsp&nbsp&nbsp+&nbsp{{
                                lastMonthIncome }}&nbsp元
                            </div>
                        </div>
                    </div>
                </el-card>
