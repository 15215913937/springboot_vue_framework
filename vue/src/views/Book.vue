    ...
    <div style="padding: 10px">
        ...
        <div style="margin: 10px 0;display: block;clear: both">
            ...
            <el-input v-model="author" placeholder="请输入作者" style="width: 15%" :prefix-icon="Search" class="mr-10"
                      clearable/>
            <el-select v-model="category" style="width: 15%;bottom: 2px" class="mr-10" placeholder="选择类别" clearable>
                <el-option
            ...
            <el-dialog v-model="dialogVisible" title="书籍信息" width="30%">
                <el-form :model="form" label-width="120px" ref="pass" :rules="rules">
                    <el-form-item label="封面">
                        <el-upload ref="upload" :action="filesUploadUrl" :limit="1" :on-exceed="handleExceed"
                    ...
                    <el-form-item label="类别">
                        <el-select v-model="form.category" style="width: 80%" placeholder="选择类别" clearable>
                            <el-option
                                    v-for="item in categories"
                                    :key="item.flag"
                                    :label="item.name"
            ...
            return {
                ...
                rules: {
                    bookname: [
                        ...
                        {min: 1, max: 50, message: '长度在1~50位之间', trigger: 'blur'},
                    ],
                    author: [
