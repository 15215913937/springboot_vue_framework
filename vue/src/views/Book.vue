<template>
    <div style="padding: 10px">
        ...
        <div style="margin: 10px 0;display: block;clear: both">
            <el-input v-model="search" placeholder="请输入书名" style="width: 20%" class="mr-10" :prefix-icon="Search"
                      clearable/>
            <el-input v-model="search" placeholder="请输入作者" style="width: 20%" :prefix-icon="Search" class="mr-10"
                      clearable/>
