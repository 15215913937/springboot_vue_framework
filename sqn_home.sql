...
INSERT INTO `book` VALUES (39, '123', '123', '123', '231', '231', '杜梅军', 123.00, '2022-07-24', NULL, 'http://localhost:9090/files/4848d8d0609c4d7e90a006d20e803d2f');
...
CREATE TABLE `user`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 41 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户信息表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `user` VALUES (44, 'tet', '$2a$10$wffWjQlmRafT0oGHs6Zmxud/2Q9TgE2CZnWYq2PtVvqiPWyF0Rrv6', NULL, NULL, NULL, NULL, '2022-07-25 00:17:28', 'ROLE_USER');
