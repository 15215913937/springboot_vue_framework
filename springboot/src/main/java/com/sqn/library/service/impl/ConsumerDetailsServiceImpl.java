...
public class ConsumerDetailsServiceImpl extends ServiceImpl<ConsumerDetailsMapper, ConsumerDetails> implements IConsumerDetailsService {
    ...
    @Override
    public List<Float> statisticsByIdAndYear(Integer id, String year) {
        ...
        return CollUtil.newArrayList(Math.round(m1 * 100) / 100f, Math.round(m2 * 100) / 100f,
                Math.round(m3 * 100) / 100f,
                Math.round(m4 * 100) / 100f, Math.round(m5 * 100) / 100f, Math.round(m6 * 100) / 100f,
                Math.round(m7 * 100) / 100f,
                Math.round(m8 * 100) / 100f, Math.round(m9 * 100) / 100f, Math.round(m10 * 100) / 100f,
